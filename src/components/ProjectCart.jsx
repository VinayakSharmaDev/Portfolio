            ...
            <div className="max-w-72 mx-auto p-2 py-4 text-[12px] border-2 rounded-sm shadow-lg bg-[#faf7f3] sm:mx-0">
                ...
                <div>
                    <ul className="flex flex-row">
                        ...
                        <li><button className="bg-[#c75b12] min-w-12 rounded-sm cursor-pointer hover:bg-amber-700 transition-colors duration-200 "><a href={data.github} target="_blank">GitHub</a></button></li>
                    </ul>
                </div>
            </div>
        </>
